...
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(@vpaydt,@vsntdt,@vtrndt,ID,RECIPIENTPHONEACCOUNTID,SENDERPHONEACCOUNTID,AMOUNT,COMMENT,COMMUNICATION,ERRORSTATUS)
set
PAYDATE = NULLIF(@vpaydt,''),
SENTDATE = NULLIF(@vsntdt,''),
TRANSACTIONDATE = NULLIF(@vtrndt,'')
;
