...
public interface TransactionJpaRepository extends JpaRepository<Transaction, Long>
{
   ...
   List<Transaction> findByAccountIdAndCheckedOrderByDateAscSequenceAsc(long accountId, boolean checked);
   List<Transaction> findByAccountIdAndCheckedOrderByDateDescSequenceDesc(long accountId, boolean checked, Pageable pageable);
